...
const InnerTile = (props) => {
    ...
    const { title, state, content1, content2, date} = props;
    ...
    <div className='innerTile'>
      <div className='innerTile-content'>
        ...
        <ul className='information-content'>
          <li className="information-content-item"><span className="label">{content1}</span></li>
          <li className="information-content-item"><span className="label">{content2}</span></li>
        </ul>
